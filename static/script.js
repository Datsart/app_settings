...
let slideDown_face = (target, duration = 500) => {
    if (window.getComputedStyle(target).display === 'none') {
        ...
        <form>
            ...
            <p>True <input type="checkbox" id="demo_gui_on_full_screen_without_borders" checked value="True"> </p>
            <p>False <input type="checkbox" id="demo_gui_on_full_screen_without_borders" value="False"> </p>
